...
<body>
<form name="diff" method="GET" action="bootstrap.php">
<input type="text" name="q1">
<input type="button" value="1" onclick ="diff.q1.value+='9'">
<a href="#" class="w-button" onclick ="diff.q1.value+='9'">Button Text</a>
<input type="submit">
</form>
